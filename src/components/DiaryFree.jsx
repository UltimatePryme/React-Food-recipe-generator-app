    ...
    <main className='bg-my-lightgreen grid grid-cols-1 justify-center'>
        <section className=''>
            <div  className=' bg-gradient-to-t from-my-green  w-full h-[26rem] relative'>
                <img src={Cakebg} alt="hero section" className='w-full h-[26rem] object-cover absolute  mix-blend-multiply' />
                <div className='flex items-center justify-center'>
                    <h1 className='absolute mb-16 bottom-5 left-0 right-0 z-2 font-Inter font-black md:text-4xl lg:text-4xl xl:text-6xl text-center text-my-lightgreen'>Selected meals <br/> that are gluten free</h1> 
                </div>
            </div>
        </section>
        ...
        {diaryFreeList.map((recipe) => {
                if (recipe.diaryFree !== false){
                    return(                    
                        <div className='bg-my-white w-[28rem] h-[29rem] mt-10 rounded-2xl cursor-pointer hover:shadow-xl'  key={recipe.id}>
                            <div className=' relative flex flex-col items-center justify-center pt-10'>
                                <div className='absolute bottom-0 left-0 right-6 bg-gradient-to-b  from-my-white hover:bg-my-lime backdrop-blur w-[18rem] ml-[5rem] h-52 justify-center p-5 rounded-t-xl' key={recipe.id}>
                                    ...
                                    <ul className='flex'>
                                        <li className='py-1 px-3 mr-1 font-Inter font-normal text-xs text-my-lightgreen bg-my-lime rounded-2xl'>{recipe.diets[1] === "diary free" || "diary free"}</li>
                                    </ul>
